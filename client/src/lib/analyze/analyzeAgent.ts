...
export async function analyzeProduct(input: AnalyzeInput) {
  ...
  const goWeek2 = `Week 2 (Day 8–20) — Turn On Ads, But Stay Disciplined: Launch Exact Match PPC on your top 3 high-intent keywords for this product (short search terms, 2–4 words maximum, directly related to what buyers type when searching for this product). Daily budget: $${dailyPpcBudget}. Starting bid: $${startingBid} — raise by $0.25 every 2 days until you start getting clicks. Check your Search Term Report every single day and add irrelevant terms as negative keywords. Your target ACoS is under ${targetAcosDisplay}%. If you're above that after Day 14, pause the worst-performing keyword and focus spend on the other two.`
